...
/**
 * <p>Представляет объект пиццы, который может быть создан с использованием
 * паттерна Builder.</p>
 *
...
public final class Pizza {
     ...
     *
     * @return Строковое представление размера пиццы (например, "Маленькая", "Средняя", "Большая").
     */
    ...
    public String toString() {
        return "Pizza:\n" +
                "  Size: " + size + "\n" +
                "  Crust: " + crust + "\n" +
                "  Sauce: " + (sauce != null && !sauce.isEmpty() ? sauce : "None") + "\n" +
                "  Toppings: " + (toppings.isEmpty() ? "None" : String.join(", ", toppings)) + "\n" +
                "  Extra Cheese: " + (extraCheese ? "Да" : "Нет");
    }

    /**
     * <p>Внутренний статический класс {@code Builder} для пошагового конструирования объектов {@code Pizza}.</p>
     *
    ...
    public static class Builder {
         ...
         *
         * @param size Строковое представление размера пиццы (например, "Средний", "Большой").
